...
public class Config {
    ...
    static {
        ...
        AUTO_PERSPECTIVE = COMMON_BUILDER.comment("When this value equals false, perspective will not be changed automatically when you get on or get off the broom.").define("auto_perspective",true);
